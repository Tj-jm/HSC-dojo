...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
         <a class="btn-floating btn-large blue" href="{{route('Admission')}}"> <i class=" fa fa-home"></i> </a> <hr>
        @if (auth::user()->role=="admin" || auth::user()->version=="English") 
            <div class="card-panel">
                <div class="card-header font-weight-bold" style="font-family: Comic Sans MS"> <h1> CHEMISTRY VIDEO LECTURES </h1>  <small class="text-info font-weight-bold">English Version</small></div>
