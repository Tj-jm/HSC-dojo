    ...
    <div class="row justify-content-center">
        ...
        @if (auth::user()->role=="admin" || auth::user()->version=="English") 
            <div class="card-panel">
                <div class="card-header font-weight-bold" style="font-family: Comic Sans MS"> <h1> MATH pdf LECTURES </h1>  <small class="text-info font-weight-bold">English Version</small></div>
