    ...
    <div class="row justify-content-center">
        ...
        @if (auth::user()->role=="admin" || auth::user()->version=="Bangla") 
            <div class="card-panel">
                <div class="card-header font-weight-bold" style="font-family: Comic Sans MS"> <h1> CHEMISTRY QUESTION SOLVE </h1>  <small class="text-info font-weight-bold">Bangla Version</small></div>
