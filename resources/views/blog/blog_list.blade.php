        ...
        <div class="col-md-8">
            ...
            <div class="card-panel ">
                ...
                <h4 style="color: #4a148c; font-family: Comic Sans MS">
                    <i class="prefix material-icons">screen_rotation</i> 
                    Please browse in landscape mode for the best experience on mobile device
               ...
               <div class="card-body">
                ...
                <div class="card-panel green accent-4 text-white">
                 ...
                 <hr style="height:2px;border-width:0;color:gray;background-color:cyan">
                  ...
                  <!-- Fast Calculation-->
                   <div class="card-panel grey darken-4 accent-4 text-white">
                    <div class="card-title font-weight-bold"><h4 style="font-family: Comic Sans MS"> Fast Calculation </h4></div>
                       <div class="card-body" style="font-family: Comic Sans MS">
                          Let's see how we can do mathematical operations (like division, power, percentage etc) in the 
                          shortest possible time
                       </div>
                       <a href="{{url('/fast_calculation')}}" class="btn white"> Let's Go to Blog </a>  
                    </div> 
                    <p class="bottom-three"></p>
                 <hr style="height:2px;border-width:0;color:gray;background-color:cyan">
                  <p class="bottom-three"></p>
