               ...
               <div class="card-body">
                <form action="/Posts" method="POST">
                    ...
                    <select name="subject" class="col-5"id="subject">
                      ...
                      <!--Admission-->
                      <option value="Question_Admission" class="list-group-item list-group-item-primary">Question Admission</option>
                      <option value="Physics_Admission" class="list-group-item list-group-item-primary">Physics Admission</option>
                      <option value="Math_Admission" class="list-group-item list-group-item-primary">Math Admission</option>
                      <option value="Chemistry_Admission" class="list-group-item list-group-item-primary">Chemistry Admission</option>
