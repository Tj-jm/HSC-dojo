    ...
    <body>
                ...
                <div class="jumbotron text-center green">
                          ...
                          <h1 class="black-text font-weight-bold display-4" >HSC-dojo</h1>      
                            ...
                            <q class="text-dark"> Please browse in landscape mode for the best experience on mobile device</q>
        ...
        <div class="container">
            ...
            <div class="card-panel">
                <div class="text-center">
                    ...
                    <iframe src="https://drive.google.com/file/d/1rmAlzgKHjiI-5wz6-Ue_H2DaAgfyJWfC/preview"
             ...
             <div class="card-panel">
                 <div class="text-center">
                     <img src="image/brand/why hsc dojo.png"  class="img-fluid" alt="Why HSC-dojo" height="800" >
             ...
             <p class="bottom-three"></p>
             @guest
                 <h5 style="font-weight: bold; color:teal;font-family:Comic Sans MS">
                    Hello, Thanks for Visiting. Want to join us? Why don't you register with us !! 
                    After that you will find all the information you need to make payment and becoming
                    a premium member. We are looking forward to having you alongside. 
